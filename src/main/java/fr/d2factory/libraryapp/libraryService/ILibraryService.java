package fr.d2factory.libraryapp.libraryService;
 ...
 *
 * The books are available via the {@link fr.d2factory.libraryapp.repositoryImpl.BookRepositoryImpl}
 */
public interface ILibraryService {
     ...
     * @see Member
     */
    Book borrowBook(final long isbnCode,  Member member, final LocalDate borrowedAt) throws HasLateBooksException;
